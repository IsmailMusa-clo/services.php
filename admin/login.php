            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image:url('img/Chechnya.jpg');"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../controller/login.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="type" value="emp" id="flexRadioDefault2" checked>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="small" href="register.php"> تسجيل مستخدم جديد</a> <br>
                                        <a class="small" href="../controller/resetpass.php">هل نسيت كلمة السر</a><br>
                                        <a class="small" href="../c-login.php">تسجيل الدخول للزوار</a>
                                    </div>
                                </div>
                            </div>
                        </div>
