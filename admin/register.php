                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!-- فورم تسجيل دخول -->
                                    <form class="user" action="../controller/register.php" method="post" enctype="multipart/form-data">
                                        <!-- الايميل -->
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control " name="image" id="image" placeholder="Enter  your avatar...">
                                        </div>
                                        <!-- الباسسورد -->
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="login.php"> هل لديك حساب بالفعل؟</a>
                                    </div>
                                </div>
                            </div>
                        </div>
